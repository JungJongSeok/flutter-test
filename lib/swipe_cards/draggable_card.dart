...
enum SlideDirection { left, right, up, bottom }
enum SlideRegion { inLeftRegion, inRightRegion, inTopRegion, inBottomRegion }
...
class _DraggableCardState extends State<DraggableCard>
    ...
    setState(() {
      if (isInLeftRegion || isInRightRegion) {
        slideRegion = isInLeftRegion
            ? SlideRegion.inLeftRegion
            : SlideRegion.inRightRegion;
      } else if (isInTopRegion) {
        slideRegion = SlideRegion.inTopRegion;
  ...
  void _onPanEnd(DragEndDetails details) {
    ...
    final isInBottomRegion = (cardOffset!.dy / context.size!.height) > 0.15;
    ...
    setState(() {
      if (isInLeftRegion || isInRightRegion) {
        ...
        if (widget.upSwipeAllowed) {
          ...
          slideOutDirection =
              isInTopRegion ? SlideDirection.up : SlideDirection.bottom;
        } else {
